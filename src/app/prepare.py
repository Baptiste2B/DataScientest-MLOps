...
def load_tfidf_vectorizer():
    ...
    vectorizer_path = os.path.join(current_dir, 'models/tfidf', 'tfidf_vectorizer.pkl')
...
def load_tfidf_vectorizer_multiclass():
    ...
    # Récupère le chemin absolu vers le dossier courant (où se trouve prepare.py)
    current_dir = os.path.dirname(os.path.abspath(__file__))
    vectorizer_path = os.path.join(current_dir, 'models/tfidf', 'tfidf_vectorizer_multiclass.pkl')
    return joblib.load(vectorizer_path)
